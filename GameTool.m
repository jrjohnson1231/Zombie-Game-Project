...
if handles.PlayerPopUp.Value==1
    if ~stop && alive
        load('timedata')
        t=t+Z;
        save('timedata','t','Z')
        ...
        while true
            ...
            handles.TimeText.String=['Time: ',num2str(round(t,2)),' hr'];
            pause(.01)
            save('timedata','t','Z')
        end
    end
