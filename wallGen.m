...
a=3; % Number of steps between each wall (y direction)
numWall=(round(ymax/a/stepLength,0)); % Number of walls stays constant for all stepLengths
wallSpacing=a*stepLength; % Space between walls in y direction
%% Create Left Walls
