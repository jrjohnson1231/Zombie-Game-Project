...
handles.hideBox.Visible='off'; % Hides things in front of game
...
% Determines axes
if y<10*stepLength % Axis is always 20*stepLength
    axmin=0;
    axmax=20*stepLength;
elseif ymax-y<10*stepLength
    ...
    axmin=y-10*stepLength; % Axis moves with player
...
% Code to plot ending images is in GameTool under arrow input function
% callback (figure1)
